...
- 開機總啟動：`D:\codexTEST\card\cards-collection\tools\startup\start-shared-ai-stack.ps1`
- 開機入口：`D:\codexTEST\card\cards-collection\tools\startup\start-shared-ai-stack.cmd`
