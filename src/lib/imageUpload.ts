...
async function uploadImageBlob(blob: Blob, folder: 'cards' | 'equipment' | 'professions' | 'achievements' | 'albums' | 'avatars', fileNameBase: string, extensionOverride?: string) {
...
export async function uploadImageFile(file: File, folder: 'cards' | 'equipment' | 'professions' | 'achievements' | 'albums' | 'avatars') {
...
export async function uploadGeneratedImageBlob(blob: Blob, folder: 'cards' | 'equipment' | 'professions' | 'achievements' | 'albums' | 'avatars', fileNameBase: string) {
